...
ROBOT_XML_DICT = {
    ...
    "adam_pro_29dof": ASSET_ROOT / "PND_adam" / "adam_pro" / "adam_pro_29dof.xml",
    "adam_pro_29dof_with_hands": ASSET_ROOT / "PND_adam" / "adam_pro" / "adam_pro_29dof_with_hands.xml",
    "adam_sp_29dof": ASSET_ROOT / "PND_adam" / "adam_sp" / "adam_sp_29dof.xml",
    "adam_sp_29dof_with_hands": ASSET_ROOT / "PND_adam" / "adam_sp" / "adam_sp_29dof_with_hands.xml",
...
IK_CONFIG_DICT = {
    ...
    "smplx":{
        ...
        "adam_pro_29dof": IK_CONFIG_ROOT / "smplx_to_adam_pro_29dof.json",
        "adam_pro_29dof_with_hands": IK_CONFIG_ROOT / "smplx_to_adam_pro_29dof.json",
        "adam_sp_29dof": IK_CONFIG_ROOT / "smplx_to_adam_sp_29dof.json",
        "adam_sp_29dof_with_hands": IK_CONFIG_ROOT / "smplx_to_adam_sp_29dof.json",
    ...
    "bvh_lafan1":{
        ...
        "adam_pro_29dof": IK_CONFIG_ROOT / "bvh_lafan1_to_adam_pro_29dof.json",
        "adam_pro_29dof_with_hands": IK_CONFIG_ROOT / "bvh_lafan1_to_adam_pro_29dof.json",
        "adam_sp_29dof": IK_CONFIG_ROOT / "bvh_lafan1_to_adam_sp_29dof.json",
        "adam_sp_29dof_with_hands": IK_CONFIG_ROOT / "bvh_lafan1_to_adam_sp_29dof.json",
    },
    "bvh_nokov":{
    ...
    "fbx_offline":{
        ...
        "adam_pro_29dof": IK_CONFIG_ROOT / "fbx_offline_to_adam_pro_29dof.json",
    },
    
    "xrobot":{
        "unitree_g1": IK_CONFIG_ROOT / "xrobot_to_g1.json",
        "adam_pro_29dof": IK_CONFIG_ROOT / "xrobot_to_adam_pro_29dof.json",
    },
}
...
ROBOT_BASE_DICT = {
    ...
    "adam_pro_29dof": "pelvis",
    "adam_pro_29dof_with_hands": "pelvis",
    "adam_sp_29dof": "pelvis",
    "adam_sp_29dof_with_hands": "pelvis",
    "tienkung": "Base_link",
    "pal_talos": "base_link",
...
VIEWER_CAM_DISTANCE_DICT = {
    ...
    "pnd_adam_lite": 3.0,
    "adam_pro_29dof": 3.0,
    "adam_pro_29dof_with_hands": 3.0,
    "adam_sp_29dof": 3.0,
    "adam_sp_29dof_with_hands": 3.0,
    "tienkung": 3.0,
    "pal_talos": 3.0,
    "fourier_gr3": 2.0,
}
